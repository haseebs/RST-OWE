...
def read_config(config_file):
    ...
    Config.set("ClusterRelations", config.getboolean("Training", "ClusterRelations", fallback=False))
    Config.set("ClusterRelationsTarget", config.get("Training", "ClusterRelationsTarget", fallback="Tails"))
    Config.set("ClusterRelationsBySize", config.getboolean("Training", "ClusterRelationsBySize", fallback=False))
    Config.set("ClusterRelationsSize", config.getint("Training", "ClusterRelationsSize", fallback=10))
    Config.set("ClusterSimilarityFactor", config.getfloat("Training", "ClusterSimilarityFactor", fallback=0.8))
    Config.set("ClusterFormingIterations", config.getint("Training", "ClusterFormingIterations", fallback=6))
    ...
    Config.set("PrintRelationPerformance", config.getboolean("Evaluation", "PrintRelationPerformance", fallback=False))
